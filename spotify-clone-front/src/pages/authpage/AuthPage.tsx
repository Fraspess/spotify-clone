          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            {mode === 'register' && (
              <div className="space-y-1.5">
                <label className="block text-sm font-medium text-text-main">Ім'я користувача</label>
                <input
                  type="text"
                  name="username"
                  ...
                  className={`w-full rounded-lg bg-bg-elevated border px-3 py-2 text-sm text-text-main placeholder:text-text-muted/70 focus:outline-none focus:ring-2 focus:ring-primary ${errors.username ? 'border-red-500' : 'border-border-subtle'}`} />
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                required
                placeholder="••••••••"
                className={`w-full rounded-lg bg-bg-elevated border px-3 py-2 text-sm text-text-main placeholder:text-text-muted/70 focus:outline-none focus:ring-2 focus:ring-primary ${errors.password ? 'border-red-500' : 'border-border-subtle'}`} />
            ...
            >
              <svg className="w-5 h-5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path d="M21.35 11.1h-9.18v2.92h5.26c-.23 1.23-1.09 3.6-5.26 3.6-3.16 0-5.75-2.6-5.75-5.8s2.59-5.8 5.75-5.8c1.8 0 3.0.78 3.72 1.46l2.54-2.48C18.03 3.05 15.94 2 12.17 2 6.64 2 2 6.64 2 12s4.64 10 10.17 10c5.86 0 9.72-4.12 9.72-9.88 0-.66-.07-1.15-.54-1.92z" fill="#4285F4" />
              </svg>
              Вхід через Google
            </button>
          </form>
